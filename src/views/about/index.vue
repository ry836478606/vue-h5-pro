<template>
	<div class="main">
		<div class="globalWrapper">
			...
			<!--通过commit来触发mutation-->
			<div class="item" style="font-weight: bold">add-globalCount-by-mutation1：<button @click="addCount">click</button></div>

			<!--通过commit来触发mutation-->
			<div class="item" style="font-weight: bold">add-globalCount-by-mutation2：<button @click="addCountByMutation({amount: 1})">click</button></div>

			<!--通过action-dispatch来触发mutation-->
			<div class="item" style="font-weight: bold">reduce-globalCount-by-action：<button @click="addCountByAction">click</button></div>
